...
const AllMealTypes = () => {
      ...
      useEffect(() => {
            ...
            const fetchCategories = async () => {
                  try {
                        const { data } = await handleApi("category/label/meal-type", "get");
                        if (isMounted) {
      ...
      const handleEdit = (id) => (
            <Link className="btn btn-primary btn-sm" to={`/meal-type/edit/${id}`}>
      ...
      return (
            <div className="p-3">
                  <div className="panel">
                        <div className="panel-header border-bottom mb-3">All MealTypes</div>

                        <div className="panel-body p-3 pb-0">
                              <DataTable2
                                    tableHeader={["ID", "Name", "Image", "Action"]}
